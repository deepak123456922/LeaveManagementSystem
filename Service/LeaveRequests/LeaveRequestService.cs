...
namespace LeaveManagementSystem.Web.Service.LeaveRequests
{
    public class LeaveRequestService(IMapper _mapper,
        ...
        ILeaveAllocationService _leaveAllocationService, ILogger<LeaveRequestService> _logger, IHttpContextAccessor _httpContextAccessor ) : ILeaveRequestService
    {
       ...
       public async Task<bool> RequestedDatesExceedAllocation(LeaveRequestCreateVM model){
       ...
       public async Task<List<LeaveRequestReadOnlyVM>> GetEmployeeLeaveRequests()
         ...
         public async Task CancelLeaveRequest(int leaveRequestId)
        {
            ...
            var allocation = await _context.LeaveAllocations.FirstAsync(q => q.LeaveTypeId == leaveRequest.LeaveTypeId && q.EmployeeId == leaveRequest.EmployeeId);
